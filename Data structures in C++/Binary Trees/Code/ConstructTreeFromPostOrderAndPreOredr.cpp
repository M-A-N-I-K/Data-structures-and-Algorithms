...
BinaryTreeNode<int> *buildTreeHelper(int *postorder, int postStart, int postEnd, int *inorder, int inStart, int inEnd)
{
    ...
    int lPostE = postStart + rootIndex - 1;
    int lInS = inStart;
    int lInE = inStart + rootIndex - 1;
    int rPostS = lPostE + 1;
    int rPostE = postEnd - 1;
    int rInS = lInE + 2;
    int rInE = inEnd;
    BinaryTreeNode<int> *leftChild = buildTreeHelper(postorder, lPostS, lPostE, inorder, lInS, lInE);
    BinaryTreeNode<int> *rightChild = buildTreeHelper(postorder, rPostS, rPostE, inorder, rInS, rInE);
    root->left = leftChild;
