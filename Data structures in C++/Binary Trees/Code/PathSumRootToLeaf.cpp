...
void rootToLeafPathsSumToKHelper(BinaryTreeNode<int> *root, int k, vector<int> vec)
{
    if (root == NULL)
    {
        return;
    ...
    if (root->left)
        rootToLeafPathsSumToKHelper(root->left, subSum, vec);
    if (root->right)
        rootToLeafPathsSumToKHelper(root->right, subSum, vec);
}
void rootToLeafPathsSumToK(BinaryTreeNode<int> *root, int k)
{
    vector<int> vec;
    rootToLeafPathsSumToKHelper(root, k, vec);
}
